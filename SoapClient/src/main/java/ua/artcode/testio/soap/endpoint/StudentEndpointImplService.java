 ...
 * 
 */
@WebServiceClient(name = "StudentEndpointImplService", targetNamespace = "http://endpoint.soap.testio.artcode.ua/", wsdlLocation = "http://192.168.1.61:9999/soap/student?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTENDPOINTIMPLSERVICE_QNAME = new QName("http://endpoint.soap.testio.artcode.ua/", "StudentEndpointImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.1.61:9999/soap/student?wsdl");
    ...
    public StudentEndpoint getStudentEndpointImplPort() {
        return super.getPort(new QName("http://endpoint.soap.testio.artcode.ua/", "StudentEndpointImplPort"), StudentEndpoint.class);
    }
    ...
    public StudentEndpoint getStudentEndpointImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://endpoint.soap.testio.artcode.ua/", "StudentEndpointImplPort"), StudentEndpoint.class, features);
    }
