 ...
 * 
 */
@WebFault(name = "RegisterException", targetNamespace = "http://endpoint.soap.testio.artcode.ua/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: ua.artcode.testio.soap.endpoint.RegisterException
     */
